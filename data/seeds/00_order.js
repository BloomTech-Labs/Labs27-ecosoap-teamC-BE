  ...
  return knex("orders").del()
    ...
    .then(function () {
      ...
      return knex("orders").insert([
        ...
        { organizationName: "Kenya unicef", organizationWebsite: "www.nairobikenya.com", contactName: "Iron Man", soapBarNum: 850, contactPhone: 9087654323, contactEmail: "nairobi@kenya.com", address: "5 upper hill Rd, Nairobi", country: "Kenya", beneficiariesNum: "300", hygieneSituation: "Excellent", hygieneInitiative: "distribution of soap in rural villages", comments: "No Comment"  },
